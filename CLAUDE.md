...
- **Entitlements File**: `Config/JPChat.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/JPChat.entitlements`:
